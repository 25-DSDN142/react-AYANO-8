...
let cheekW = map(eyeDist, 40, 200, 40, 140);  
let cheekH = map(eyeDist, 40, 200, 25, 90);   

//eye
let lensStrokeW = map(eyeDist, 40, 200, 6, 18);   
let eyeStrokeW  = map(eyeDist, 40, 200, 4, 12);   
let lashStrokeW = map(eyeDist, 40, 200, 3, 10);   
let noseStrokeW = map(eyeDist, 40, 200, 2, 6);  

let r = max(leftEyeWidth, leftEyeHeight) * 2; 

let lashLength = map(eyeDist, 40, 200, 5, 25);
let lashAnglesLeft = [PI/4, PI/4 + 0.15, PI/4 - 0.15];   
let lashAnglesRight = [3*PI/4, 3*PI/4 + 0.15, 3*PI/4 - 0.15]; 
...
fill(222,184,135); 
arc(leftEyeCenterX, leftEyeCenterY, r, r, PI, 0);  
arc(rightEyeCenterX, rightEyeCenterY, r, r, PI, 0); 
